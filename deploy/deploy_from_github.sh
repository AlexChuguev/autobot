...
PROJECT_DIR="${PROJECT_DIR:-/var/www/ecommerce-site}"
REPO_SSH_URL="${REPO_SSH_URL:-git@github.com:AlexChuguev/autobot.git}"
DEPLOY_KEY_PATH="${DEPLOY_KEY_PATH:-/root/.ssh/id_ed25519_github}"
BRANCH="${BRANCH:-main}"
